...
Recuerdo que hay un bug de tabulador en el que no puedes tocar el carrito o el logout, hay que corregirlo y ver que más hay 

Esto es respecto al carrito
...
// NUEVO: El selector de elementos que pueden recibir foco
...
Y este es el header, ahora ya es focusable por el navegador
...
El código es escalable casi al infito, pero considero haber logrado un producto mínimo viable, pero para el futuro hay algunas cosas que podríamos mejorar

- Añadir una vista de detalle para cada producto
- Pulir los estilos del header para que te siga cuando haces escroll en la página
- Implementar el Helmet para SEO dinámico
- Incluir una pasarela de pago real
- Implementar la paginación
- Crear un footer y una página "Sobre nosotros"
- Entre otras cosas
